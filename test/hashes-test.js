...
describe('Ledger', function() {
  ...
  describe('#calcCallStateEntryHash', function() {
    it('will calculate the CallState entry hash for rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh and rB5TihdPbKgMrkFqrqUC3yLdE8hhv4BdeY in USD', function() {
    ...
    it('will calculate the CallState entry hash for r3kmLJN5D28dHuH8vZNUZpMC43pEHpaocV and rUAMuQTfVhbfqUDuro7zzy4jj4Wq57MPTj in UAM', function() {
  ...
  describe('#computeSignerListHash', function() {
    ...
    #Start a calld standalone server and issue the following commands:

    ./build/calld submit "masterpassphrase" '
    {
    ...
    ./build/calld ledger_accept

    # Get signer list information
    build/calld account_objects rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh
    */
